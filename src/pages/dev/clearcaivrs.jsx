...
class ClearCaivrs extends React.Component {
  render() {
    return (
      <>
        <ExamplePage
        ...
        >
          ...
          <p>
            ...
            allowing them to fill out a contact form if desired. Additionally,
            the president made a dedicated hotline for leads with greater
            urgency.
          </p>
          <p>
